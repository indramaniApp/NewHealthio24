import { StyleSheet, Text, View, TouchableOpacity, SafeAreaView, StatusBar, ScrollView } from 'react-native'; // 🔥 Imports add kiye gaye
...
  return (
    ...
    >
      <SafeAreaView style={styles.safeArea}>
        ...
        {/* 🔥 Header ka background transparent karein */}
        <Header 
            title="Patient Mitra" 
...
  container: {
    // 🔥 flex: 1 hata diya, ab ye ScrollView ka content container hai
    backgroundColor: 'transparent', // 🔥 Background transparent
    paddingTop: SIZES.base, // 🔥 Padding adjust kiya
    paddingBottom: 20,
  },
  card: {
    flexDirection: 'row',
