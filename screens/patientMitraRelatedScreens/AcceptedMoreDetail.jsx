...
const AcceptedMoreDetail = () => {
  ...
  const fetchDetails = async () => {
    try {
      ...
      console.log('Accepted Appointment Detail:', response);
  ...
  const renderHeader = () => (
    <View style={styles.screenHeader}>
      ...
      <Text style={styles.screenTitle}>Accepted PM Package Details</Text>
    </View>
  );
  ...
  const renderCard = ({ item }) => (
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        ...
        <Text style={styles.cardHeaderText}>Accepted Booking</Text>
      ...
      <View style={{ marginTop: 10 }}>
        <Text style={styles.bookedOn}>Booked on: {formatDateTime(item?.accepted_date)}</Text>
      </View>
    </View>
  );
...
export default AcceptedMoreDetail;
