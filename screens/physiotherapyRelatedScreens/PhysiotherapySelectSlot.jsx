...
const PhysiotherapySelectSlot = ({ navigation,route }) => {
    ...
    console.log('Selected ID:=======', centreId);
    ...
    const handleBookByWallet = () => {
        ...
        navigation.navigate('PhysiotherapyBookByWallet', {
    ...
    const handleBookByPayment = () => {
        setShowPaymentModal(false);
        navigation.navigate('PhysiotherapyBookByPayment', {
            startedDate: selectedDate,
            selectedHour,
            centreId,
        });
...
export default PhysiotherapySelectSlot;
