...
const PhysiotherapyScheduled = () => {
  ...
  const fetchAppointments = async () => {
    try {
      dispatch(showLoader());
      const res = await ApiService.get(ENDPOINTS.physiotherapys_book);
    ...
    <View style={styles.card}>
      ...
      <View style={styles.actions}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('PhysiotherapyMoreDetails', { id: item._id })}
        >
  ...
  return (
    <SafeAreaView style={styles.container}>
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={styles.empty}>No upcoming physiotherapy appointments.</Text>
        }
      />
    </SafeAreaView>
  );
...
export default PhysiotherapyScheduled;
