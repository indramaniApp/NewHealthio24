...
const DoctorReviews = ({ navigation }) => {
                ...
                <TouchableWithoutFeedback
                    ...
                    <View style={[styles.modalContainer]}>
                        <View style={[styles.modalSubContainer, {
                            ...
                            />
                            <TextInput
                                placeholder="Dr. Jenny is very professional 🔥"
    ...
    */
    const renderContent = () => {
        ...
        const filteredReviews = selectedRating === "All" ? doctorReviews : doctorReviews.filter(review => review.avgRating === selectedRating);
        return (
            <ScrollView
