                    ...
                    <ScrollView contentContainerStyle={styles.scrollViewContent}>
                        ...
                        <View style={styles.formContainer}>
                            ...
                            <View style={[
                                styles.inputWrapper,
                                {
                                    backgroundColor: dark ? COLORS.darkCard : '#F4F6F9',
                                    borderColor: isPhoneValid ? COLORS.green : COLORS.primary,
                                }
                            ]}>
                            ...
                            <Button
                                ...
                                style={[
                                    styles.button,
                                    {
                                        backgroundColor: isPhoneValid ? COLORS.primary : COLORS.gray,
                                    },
                                ]}
