...
const GetBookingMoreDetail = () => {
  ...
  const fetchApprovedAppointments = async () => {
    try {
      dispatch(showLoader());
      const response = await ApiService.get(`${ENDPOINTS.approved_pathology_appointment}/${id}`);
  ...
  const renderCard = ({ item }) => (
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        ...
        <Text style={styles.cardHeaderText}>Approved Lab Appointment</Text>
      ...
      <View style={styles.section}>
        <InfoLabel label="Package" value={item.notes} />
...
export default GetBookingMoreDetail;
