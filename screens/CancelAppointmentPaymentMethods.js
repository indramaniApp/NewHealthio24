...
const CancelAppointmentPaymentMethods = ({ navigation }) => {
          ...
          <View style={styles.modalContainer}>
            <View style={[styles.modalSubContainer, {
              ...
              <Text style={[styles.modalSubtitle, {
                ...
                You have successfully canceled your appointment. 80% funds will returned to your account.
              </Text>
              <Button
                title="Okay"
                filled
...
export default CancelAppointmentPaymentMethods