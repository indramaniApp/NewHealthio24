...
// LinearGradient import पहले से ही मौजूद है
import LinearGradient from 'react-native-linear-gradient';

const MyAppointmentVideoCall = ({ navigation, route }) => {
    const { name, age, gender, problem, appointment_approve_date, appointment_type, appointment_payment, doctor_cities, doctor_addresses, specialization = [], doctor_names, doctor_photos } = route.params;
    ...
    const renderContent = () => {
        return (
            <View>
                {/* डॉक्टर कार्ड के लिए ग्रेडिएंट को बरकरार रखा गया है जैसा कि आपके मूल कोड में था */}
                <LinearGradient
                ...
                >
                    ...
                    <View style={{ flex: 1, paddingRight: 16 }}>
                        ...
                        <Text style={[styles.doctorHospital, {
                            color: dark ? COLORS.grayscale400 : COLORS.greyScale800
                        }]}>{doctor_addresses},{doctor_cities} </Text>
                    </View>
                </LinearGradient>
