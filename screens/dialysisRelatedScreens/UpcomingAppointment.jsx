  ...
  const renderItem = ({ item }) => (
    <View style={styles.card}>
      <View style={styles.headerRow}>
        <MaterialCommunityIcons name="water-pump" size={20} color={COLORS.primary} />
      ...
      <View style={styles.actions}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('MoreDetailScreen', { id: item._id })}
        >
  ...
  return (
    <SafeAreaView style={styles.container}>
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={styles.empty}>No upcoming dialysis appointments.</Text>
        }
      />
    </SafeAreaView>
  );
