...
const DialysisBookByWallet = ({ route, navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    const finalUrl = `${ENDPOINTS.book_appointment_dialysis_wallet}/${unitId}`;
    ...
    try {
      ...
      if (response?.status === 'success') {
        Alert.alert('Success', response?.message || 'Appointment booked successfully!', [
          { text: 'OK', onPress: () => navigation.navigate('Dialysis') },
        ]);
      } else {
...
export default DialysisBookByWallet;
