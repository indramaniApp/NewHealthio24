...
const DialysisBookByPayment = ({ route, navigation }) => {
  ...
  const [referralId, setReferralId] = useState(''); // ✅ New state
  ...
  const handleSubmit = async () => {
    ...
    try {
      const data = {
        ...
        referral_id: referralId, // ✅ Added to payload
      };
...
const styles = StyleSheet.create({
  ...
  pickerWrapper: { backgroundColor: '#ffffff', borderColor: '#D1D5DB', borderWidth: 1, borderRadius: 12, overflow: 'hidden', marginBottom: 16 },
  picker: { height: 48, color: '#111827', paddingHorizontal: 16 },
  button: { backgroundColor: COLORS.primary, paddingVertical: 14, borderRadius: 12, alignItems: 'center', marginTop: 10, elevation: 4 },
