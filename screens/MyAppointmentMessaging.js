...
const styles = StyleSheet.create({
  ...
  headerContainer: {
    flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingBottom: 16
  },
  ...
  doctorCard: {
    height: 142, width: SIZES.width - 32, borderRadius: 16, flexDirection: "row", alignItems: "center", marginVertical: 12
  },
  doctorImage: { height: 110, width: 110, borderRadius: 16, marginHorizontal: 16 },
  doctorName: { fontSize: 18, fontFamily: "Urbanist Bold" },
  ...
  subtitle: { fontSize: 20, fontFamily: "Urbanist Bold", marginVertical: 8 },
  description: { fontSize: 14, fontFamily: "Urbanist Regular", marginVertical: 6 },
  viewContainer: { flexDirection: "row", marginVertical: 2 },
  viewLeft: { width: 120 },
  pkgContainer: {
    height: 100, width: SIZES.width - 32, borderRadius: 16, flexDirection: "row",
    alignItems: "center", justifyContent: "space-between", marginVertical: 12
  },
  pkgLeftContainer: { flexDirection: "row", alignItems: "center" },
  pkgIconContainer: {
    height: 60, width: 60, borderRadius: 999, alignItems: "center", justifyContent: "center",
    marginLeft: 12, marginRight: 12
  },
  pkgIcon: { height: 24, width: 24 },
  pkgTitle: { fontSize: 16, fontFamily: "Urbanist Bold", marginVertical: 8 },
  pkgDescription: { fontSize: 14, fontFamily: "Urbanist Regular" },
  pkgRightContainer: { alignItems: "center", marginRight: 12 },
  pkgPrice: { fontSize: 18, fontFamily: "Urbanist Bold", color: COLORS.primary, marginBottom: 4 },
  pkgPriceTag: { fontSize: 10, fontFamily: "Urbanist Medium" }
});
