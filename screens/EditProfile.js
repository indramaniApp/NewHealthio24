            ...
            >
                <View style={styles.container}>
                    ...
                    <ScrollView
                        ...
                        contentContainerStyle={styles.scrollContainer} // <-- यहाँ स्टाइल जोड़ा गया
                    >
...
const styles = StyleSheet.create({
    ...
    scrollContainer: { // <-- स्क्रॉल के लिए स्टाइल
        flexGrow: 1,
        paddingBottom: 80,
    },
    container: { flex: 1, paddingHorizontal: 16 }, // <-- यहाँ से backgroundColor हटा दिया गया
    ...
    bottomContainer: { paddingBottom: 24, paddingTop: 12 }, // <-- यहाँ marginVertical की जगह padding दिया
