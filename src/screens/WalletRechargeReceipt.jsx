...
const WalletRechargeReceipt = ({ route,navigation }) => {
    ...
    const generatePDF = async (item) => {
      ...
      <html>
        ...
        <body>
          <h1>Healthio24</h1>
          <h2>Wallet Recharge Receipt / Tax Invoice</h2>
          ...
          <div class="section">
            ...
            <div class="row"><div><b>Status:</b></div><div>${item.status}</div></div>
             <div class="row"><div><b>Status:</b></div><div>${item.purpose}</div></div>
    ...
    const renderItem = ({ item }) => (
        <View style={[styles.card, { backgroundColor: dark ? COLORS.dark2 : COLORS.white }]}>
            ...
            <Text style={[styles.subHeader, { color: COLORS.gray }]}>Wallet Recharge Receipt / Tax Invoice</Text>
            ...
            <TextItem label="Status" value={item.status} dark={dark} />
            ...
            <View style={[styles.row]}>
                <Text style={[styles.totalText, { color: COLORS.primary }]}>Purpose</Text>
                <Text style={[styles.totalText, { color: COLORS.primary }]}>{item.purpose}</Text>
            </View>
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: dark ? COLORS.dark1 : COLORS.white }}>
            <Header title={'Wallet Recharge Recipt'} />
...
export default WalletRechargeReceipt;
